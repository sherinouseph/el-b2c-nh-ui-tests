...
public class ChromeSimulatorGoogleNexus7WebDriver extends BaseRemoteWebDriver {

    private static final Logger logger = LoggerFactory.getLogger(RemoteWebDriver.class);

    static {
        simulatorDeviceName= "Google Nexus 7";
    ...
    public ChromeSimulatorGoogleNexus7WebDriver() throws MalformedURLException , ConnectException, Exception {
            super(new URL(nodeURL), capability);
    }
    public ChromeSimulatorGoogleNexus7WebDriver(String deviceName) throws MalformedURLException , ConnectException, Exception {
        super(new URL(nodeURL), capability);
