 ...
 *         &lt;element name="salesOrder_id" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/>
...
@XmlRootElement(name = "GetReceiptInfoList")
public class GetReceiptInfoList {

    @XmlElement(name = "member_id")
    protected Integer memberId;
    @XmlElement(name = "salesOrder_id")
    protected Integer salesOrderId;
    @XmlElementRef(name = "salesOrderItem_id", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
