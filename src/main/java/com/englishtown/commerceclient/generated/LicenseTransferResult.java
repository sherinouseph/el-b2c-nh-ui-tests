 ...
 *                         </summary>
 * 
 * <p>Java class for LicenseTransferResult complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LicenseTransferResult">
 *   &lt;complexContent>
...
@XmlType(name = "LicenseTransferResult", namespace = "EFSchools.Englishtown.Commerce.Client.Subscriptions", propOrder = {
    "isSucceed",
    "errorCode",
    "redemptionCode"
})
public class LicenseTransferResult {
    ...
    @XmlElementRef(name = "ErrorCode", namespace = "EFSchools.Englishtown.Commerce.Client.Subscriptions", type = JAXBElement.class, required = false)
    protected JAXBElement<String> errorCode;
    @XmlElementRef(name = "RedemptionCode", namespace = "EFSchools.Englishtown.Commerce.Client.Subscriptions", type = JAXBElement.class, required = false)
