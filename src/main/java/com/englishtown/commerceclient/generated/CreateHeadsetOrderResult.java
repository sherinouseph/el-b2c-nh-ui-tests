...
/**
 * <p>Java class for CreateHeadsetOrderResult complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CreateHeadsetOrderResult">
 *   &lt;complexContent>
...
@XmlType(name = "CreateHeadsetOrderResult", namespace = "EFSchools.Englishtown.Commerce.Client.Headset", propOrder = {
    "isSucceed",
    "errorCode"
})
public class CreateHeadsetOrderResult {

    @XmlElement(name = "IsSucceed")
    protected Boolean isSucceed;
    @XmlElementRef(name = "ErrorCode", namespace = "EFSchools.Englishtown.Commerce.Client.Headset", type = JAXBElement.class, required = false)
