...
@XmlRootElement(name = "AssociateMemberWithDivisionByLicenseCode")
public class AssociateMemberWithDivisionByLicenseCode {
    ...
    @XmlElementRef(name = "licenseCode", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> licenseCode;
     ...
     *     
     */
    public JAXBElement<String> getLicenseCode() {
        return licenseCode;
    }
     ...
     *     
     */
    public void setLicenseCode(JAXBElement<String> value) {
