...
/**
 * On thank you page click start and click start enroll
 *
 * Enrolment page shown with few steps user has to select
 * User: nikol.marku
 * Date: 16/01/19
 *
 *  TODO  update to new house NOt sure if we need this
 *  This page should contain MotivationPage and EnglishLevelPage
 *
 *  Motivation ---> level ---> Start learning
 */
...
public class NewHouseEnrolmentPage extends BaseSchoolPage {

    public static final Logger logger = LoggerFactory.getLogger(NewHouseEnrolmentPage.class);
    public static final String enrolmentPageUrl = "/campus/enrollment/b2c/entrance#";  //TODO this should be dynamic
    ...
    public NewHouseEnrolmentPage(WebDriver webDriver){
        super(webDriver);
    }

    public NewHouseEnrolmentPage(WebDriver webDriver, String url) {
        super(webDriver, url);
    }

    public NewHouseEnrolmentPage(WebDriver webDriver, int waitTimeSec) {
        super(webDriver, waitTimeSec);
    }

    public NewHouseEnrolmentPage() {
        this(null, null);
    }
