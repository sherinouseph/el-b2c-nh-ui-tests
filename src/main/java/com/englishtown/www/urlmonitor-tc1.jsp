        ...
        <%
          ...
          if (selectedTest != null ) {
              ...
              <%if (selectedTest != null ) { %>
                   ...
                   <input type="submit" onclick="showGraph()" height:120px; width:350px; style="font-face: 'Comic Sans MS'; font-size: larger; color: teal; background-color:FFCC99; border: 2pt ridge lightgrey" value=" Show Graph ! "> </button><br>
              <%}%>
