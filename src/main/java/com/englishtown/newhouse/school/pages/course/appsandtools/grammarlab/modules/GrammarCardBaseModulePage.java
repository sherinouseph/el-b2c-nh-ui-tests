...
public abstract class GrammarCardBaseModulePage extends BaseSchoolPage {

    public static final Logger logger = LoggerFactory.getLogger(GrammarCardBaseModulePage.class);
...
//    }
    ...
    public GrammarCardBaseModulePage(WebDriver webDriver){
        super(webDriver);
    }
    public GrammarCardBaseModulePage(WebDriver webDriver, String url) {
        super(webDriver, url);
    }
    public GrammarCardBaseModulePage(WebDriver webDriver, int timeoutSec) {
        super(webDriver, timeoutSec);
    }
    public GrammarCardBaseModulePage() {
        this(null, null);
    }
...
//    }
    ...
    public abstract void checkAllCardsElementsDisplayed(int index);
