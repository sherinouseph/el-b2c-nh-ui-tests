 ...
 * Click on a topic shows the lessons
 *
 */
...
public class GrammarLabTopicLessonModulePage extends GrammarCardBaseModulePage {

    public static final Logger logger = LoggerFactory.getLogger(GrammarLabTopicLessonModulePage.class);
//    public static final String pageUrl = "/1/apps-and-tools/grammarlab/";
//
//    public final String TOPIC_CSS            = "grammarlab";    // class  main Parent
//    public final String TOPIC_LESSONLIST_CSS = ".grammarlab [class^='card_']"; //list of topics  has card_
//    //--------------------------------------------------------------------------------------
    /**
...
//    public final String getStartedBtnCss       = "[class^='button_']";
    ...
    public final String activityCss            = "[class^='activities_']";   // a list of lessons in here // activity has columns TODO latter


//    @FindBy(className = TOPIC_CSS)
//    public WebElement topicWe;
//
//    @FindBy(css = TOPIC_LESSONLIST_CSS)
...
//    }
    ...
    public WebElement getCardElement(int cardTopicIndex, GrammarLabTopic topicCardDetails){
        ...
        switch (topicCardDetails){
            ...
            case DESC:   // note here is activity
                logger.info("Case [{}]", topicCardDetails);
                webElement = WebElementHelper.safeFindElement(topicCardListWe.get(cardTopicIndex), By.cssSelector(activityCss));
                break;
    ...
    public void checkAllCardsElementsDisplayed(int cardTopicIndex){
        for(GrammarLabTopic card : GrammarLabTopic.values()){
            ...
            if(!card.equals(GrammarLabTopic.LESSON_COUNT))
...
//    }
    ...
    public GrammarLabTopicLessonModulePage(WebDriver webDriver){
        super(webDriver);
    }
    public GrammarLabTopicLessonModulePage(WebDriver webDriver, String url) {
        super(webDriver, url);
    }
    public GrammarLabTopicLessonModulePage(WebDriver webDriver, int timeoutSec) {
        super(webDriver, timeoutSec);
    }
    public GrammarLabTopicLessonModulePage() {
        this(null, null);
    }
