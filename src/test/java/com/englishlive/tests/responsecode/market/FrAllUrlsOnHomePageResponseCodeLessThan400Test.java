...
//
// //not needed
//public class FrAllUrlsOnHomePageResponseCodeLessThan400Test extends BaseAllUrlsOnPageResponseCodeTest {
//    private static final Logger logger = LoggerFactory.getLogger(FrAllUrlsOnHomePageResponseCodeLessThan400Test.class);
