...
public class DEAllUrlsOnHomePageResponseCodeLessThan400Test extends BaseAllUrlsOnPageResponseCodeTest {
    private static final Logger logger = LoggerFactory.getLogger(DEAllUrlsOnHomePageResponseCodeLessThan400Test.class);
