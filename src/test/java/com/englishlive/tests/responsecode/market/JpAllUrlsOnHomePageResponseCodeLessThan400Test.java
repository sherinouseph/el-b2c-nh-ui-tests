...
//
//
//public class JpAllUrlsOnHomePageResponseCodeLessThan400Test extends BaseAllUrlsOnPageResponseCodeTest {
//    private static final Logger logger = LoggerFactory.getLogger(JpAllUrlsOnHomePageResponseCodeLessThan400Test.class);
