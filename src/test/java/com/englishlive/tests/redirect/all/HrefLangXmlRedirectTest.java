...
public class HrefLangXmlRedirectTest extends BaseHtmlUnitDriverTest {
    private static final Logger logger = LoggerFactory.getLogger(HrefLangXmlRedirectTest.class);
    private static int waitTime = 15 ;


    @Test(dataProvider = "hrefLangXmlUrls", dataProviderClass = UrlDataProvider.class, threadPoolSize = 5, invocationCount = 1, timeOut = 60000 )
