...
// WWS not used anymore
//public class ELiveRedirectTest extends BaseHtmlUnitDriverTest { //} BaseHtmlUnitDriverConfig implements ITest {
//    private static final Logger logger = LoggerFactory.getLogger(ELiveRedirectTest.class);
//    private static int waitTime = 15 ;
//
//
//    @Test(dataProvider = "eLiveAllUrlRedirect", dataProviderClass = UrlDataProvider.class, threadPoolSize = 7, invocationCount = 1, timeOut = 120000 )
//    public void opentUrlCheckRedirectUrlTest(UrlRedirectBean urlRedirectBean) throws Exception{
//        try {
//            createLocalThreadDriver(MyBrowserType.CHROME_HEADLESS, 35); //MyBrowserType.HTMLUNIT
