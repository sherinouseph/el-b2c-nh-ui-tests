...
// ff only test
public class BrETownHeadlessDownloadPDFcheckREsponseTest extends BaseResponseCodeTest {
    private static final Logger logger = LoggerFactory.getLogger(BrETownHeadlessDownloadPDFcheckREsponseTest.class);
    @Value("#{applicationPropertiesList['br.etown.fc.pdf.url']}")
