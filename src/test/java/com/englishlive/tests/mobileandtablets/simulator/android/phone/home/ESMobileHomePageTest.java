...
//
//public class ESMobileHomePageTest extends MobileHomePage {
//    private static final Logger logger = LoggerFactory.getLogger(ESMobileHomePageTest.class);
//    @Value("#{applicationPropertiesList['home.mobile.es.es.url']}")
