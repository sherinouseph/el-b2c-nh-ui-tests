...
//
//public class GBMobileHomePageTest extends MobileHomePage {
//    private static final Logger logger = LoggerFactory.getLogger(GBMobileHomePageTest.class);
//    @Value("#{applicationPropertiesList['home.mobile.en.gb.url']}")
