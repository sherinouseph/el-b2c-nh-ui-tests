...
//
//public class TWMobileHomePageTest extends MobileHomePage {
//    private static final Logger logger = LoggerFactory.getLogger(TWMobileHomePageTest.class);
//    @Value("#{applicationPropertiesList['home.mobile.zh.tw.url']}")
