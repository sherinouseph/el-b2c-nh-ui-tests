...
//
//public class JPMobileHomePageTest extends MobileHomePage {
//    private static final Logger logger = LoggerFactory.getLogger(JPMobileHomePageTest.class);
//    @Value("#{applicationPropertiesList['home.mobile.ja.jp.url']}")
