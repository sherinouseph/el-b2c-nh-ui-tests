...
//
//public class TRMobileHomePageTest extends MobileHomePage {
//    private static final Logger logger = LoggerFactory.getLogger(TRMobileHomePageTest.class);
//    @Value("#{applicationPropertiesList['home.mobile.tr.tr.url']}")
