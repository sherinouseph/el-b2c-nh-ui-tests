...
//
//public class USMobileHomePageTest extends MobileHomePage {
//    private static final Logger logger = LoggerFactory.getLogger(USMobileHomePageTest.class);
//    @Value("#{applicationPropertiesList['home.mobile.en.us.url']}")
//    private String pageUrl;
//
//    @BeforeClass
//    void setup(){
//        mobileTestUrl = pageUrl;
//        setLanguageAndMarket("en","us");
//    }
//}
