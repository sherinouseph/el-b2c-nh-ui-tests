...
//
//
//public class CcFRCheckoutWithOfferId31332Test extends NewCcBaseCheckoutFlowTest {
//    private static final Logger logger = LoggerFactory.getLogger(CcFRCheckoutWithOfferId31332Test.class);
//    @Value("#{applicationPropertiesList['member.fr.fr.offerid31332.url']}")
