...
//
//
//public class CcUsEnCheckoutWithOfferId30436Test extends NewCcBaseCheckoutFlowTest {
//    private static final Logger logger = LoggerFactory.getLogger(CcUsEnCheckoutWithOfferId30436Test.class);
//    @Value("#{applicationPropertiesList['member.en.us.offerid30436.url']}")
