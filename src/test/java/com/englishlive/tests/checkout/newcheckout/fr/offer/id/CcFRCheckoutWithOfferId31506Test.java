...
//
//
//public class CcFRCheckoutWithOfferId31506Test extends NewCcBaseCheckoutFlowTest {
//    private static final Logger logger = LoggerFactory.getLogger(CcFRCheckoutWithOfferId31506Test.class);
//    @Value("#{applicationPropertiesList['member.fr.fr.offerid31506.url']}")
