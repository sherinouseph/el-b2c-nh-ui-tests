...
//
//
//public class CcFRCheckoutWithOfferId31507Test extends NewCcBaseCheckoutFlowTest {
//    private static final Logger logger = LoggerFactory.getLogger(CcFRCheckoutWithOfferId31507Test.class);
//    @Value("#{applicationPropertiesList['member.fr.fr.offerid31507.url']}")
