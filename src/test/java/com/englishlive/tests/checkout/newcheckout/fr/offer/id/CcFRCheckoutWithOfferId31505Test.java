...
//
//
//public class CcFRCheckoutWithOfferId31505Test extends NewCcBaseCheckoutFlowTest {
//    private static final Logger logger = LoggerFactory.getLogger(CcFRCheckoutWithOfferId31505Test.class);
//    @Value("#{applicationPropertiesList['member.fr.fr.offerid31505.url']}")
