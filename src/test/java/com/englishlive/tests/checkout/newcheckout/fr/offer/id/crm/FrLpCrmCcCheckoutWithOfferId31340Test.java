...
//
//
//public class FrLpCrmCcCheckoutWithOfferId31340Test extends LPtoCheckoutWithOfferId {
//    private static final Logger logger = LoggerFactory.getLogger(FrLpCrmCcCheckoutWithOfferId31340Test.class);
//    @Value("#{applicationPropertiesList['lp.os.fr.crm.offerid31340.url']}")
