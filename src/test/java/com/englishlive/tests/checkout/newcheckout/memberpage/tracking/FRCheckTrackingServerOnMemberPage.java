...
public class FRCheckTrackingServerOnMemberPage extends BaseCheckTrackingServerOnMemberPage {
    private static final Logger logger = LoggerFactory.getLogger(FRCheckTrackingServerOnMemberPage.class);
