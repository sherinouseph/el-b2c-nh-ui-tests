...
////flow changed
//
//public class Fr1LandingFormToCcCheckoutWithPcode extends LandingPageToCheckoutFlowTests {
//    private static final Logger logger = LoggerFactory.getLogger(Fr1LandingFormToCcCheckoutWithPcode.class);
//    @Value("#{applicationPropertiesList['checkout.os.fr.pcode1.url']}")
...
//        this.offer = EfConstants.FR_OFFER_30494;
