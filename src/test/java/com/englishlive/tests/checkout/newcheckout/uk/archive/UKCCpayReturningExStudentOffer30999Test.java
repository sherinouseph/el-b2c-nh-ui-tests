...
//
//
//public class UKCCpayReturningExStudentOffer30999Test extends BaseCCpayReturningStudent {
//
//    private static final Logger logger = LoggerFactory.getLogger(UKCCpayReturningExStudentOffer30999Test.class);
//
//    @Value("#{applicationPropertiesList['checkout.member.en.en.url']}")
//    protected String currMemberPageUrl;
//
//    private final String OFFER_ID = "30999";
//
//    @BeforeClass
//    public void setup(){
//        setThreadSafeDriver();
