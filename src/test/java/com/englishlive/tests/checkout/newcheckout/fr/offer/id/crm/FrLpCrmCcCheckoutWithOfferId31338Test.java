...
// // sind they havent bother to fix this as it goes to old checkout then this test is not needed
//
//public class FrLpCrmCcCheckoutWithOfferId31338Test extends LPtoCheckoutWithOfferId {
//    private static final Logger logger = LoggerFactory.getLogger(FrLpCrmCcCheckoutWithOfferId31338Test.class);
//    @Value("#{applicationPropertiesList['lp.os.fr.crm.offerid31338.url']}")
...
//        this.offer = EfConstants.OFFER_ID_31338;
