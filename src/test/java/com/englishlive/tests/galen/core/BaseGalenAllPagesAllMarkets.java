 ...
 *
 * Note First test run in chrome as is set to default. BaseGalenConfig - Set default browser type [ CHROME ]...! .. TODO fix this
 *
 */
...
public abstract class BaseGalenAllPagesAllMarkets extends BaseGalen {
    ...
    private String itHowItWorksUrl= itUrl+"come-funziona/";
    ...
    public void GB_CrmMagicExistUserForgetPassForm_imageTest_Chrome(TestDevice device) throws IOException {
    ...
    @Test(dataProvider = "devicesImageTest", dataProviderClass = DevicesDataProvider.class)
    public void GB_CrmMagicExistUserLoginForm_imageTest_Chrome(TestDevice device) throws IOException {
    ...
    @Test(dataProvider = "devicesImageTest", dataProviderClass = DevicesDataProvider.class)
    public void GB_CrmMagicNewUserForm_imageTest_Chrome(TestDevice device) throws IOException {
    ...
    @Test(dataProvider = "devicesImageTest", dataProviderClass = DevicesDataProvider.class)
    public void DE_PricePage_bg_imageTest_Chrome(TestDevice device) throws IOException {
    ...
    @Test(dataProvider = "devicesImageTest", dataProviderClass = DevicesDataProvider.class)
    public void DE_HomePage_Illustator1_imageTest_Chrome(TestDevice device) throws IOException {
