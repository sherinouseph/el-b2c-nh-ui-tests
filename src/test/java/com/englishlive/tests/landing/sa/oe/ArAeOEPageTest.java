 ...
 *2017
 */
public class ArAeOEPageTest extends BaseOEPageTest{
    private static final Logger logger = LoggerFactory.getLogger(ArAeOEPageTest.class);

    @Value("#{applicationPropertiesList['sa.oe.crm.ae']}")
    ...
    protected void setup(){
        ...
        formDataMap = EfConstants.SA_OECMRM_MAP;
    }
