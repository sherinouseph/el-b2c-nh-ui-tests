...
//
//
//public class FR4freePLTest extends BaseOETest { //FRfreePLTest {
//    private static final Logger logger = LoggerFactory.getLogger(FR4freePLTest.class);
//    @Value("#{applicationPropertiesList['fr.freepl4']}")
