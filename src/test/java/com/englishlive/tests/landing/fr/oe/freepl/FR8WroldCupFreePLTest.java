...
//
//
//public class FR8WroldCupFreePLTest extends BaseOETest { //FRfreePLTest {
//    private static final Logger logger = LoggerFactory.getLogger(FR8WroldCupFreePLTest.class);
