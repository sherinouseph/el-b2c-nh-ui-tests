...
//// flow changed
//public class Fr3OSPageTest extends BaseOSPageTest {
//    private static final Logger logger = LoggerFactory.getLogger(Fr3OSPageTest.class);
//    @Value("#{applicationPropertiesList['fr3.os.url']}")
