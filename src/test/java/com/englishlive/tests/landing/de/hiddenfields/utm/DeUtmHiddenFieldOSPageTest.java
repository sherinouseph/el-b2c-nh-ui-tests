...
public class DeUtmHiddenFieldOSPageTest extends BaseUtmHiddenField {
    private static final Logger logger = LoggerFactory.getLogger(DeUtmHiddenFieldOSPageTest.class);

    @Value("#{applicationPropertiesList['de1.os.utm.url']}")
