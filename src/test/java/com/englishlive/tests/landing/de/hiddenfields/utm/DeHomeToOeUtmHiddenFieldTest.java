...
public class DeHomeToOeUtmHiddenFieldTest extends BaseUtmHiddenField {
    private static final Logger logger = LoggerFactory.getLogger(DeHomeToOeUtmHiddenFieldTest.class);
