//package com.englishlive.tests.landing.de.earningscalculator.lead;
///**
// *
// */
...
//
//public class DeLeadEarningCalculatorTest extends BaseLeadEarningCalculator {
//    private static final Logger logger = LoggerFactory.getLogger(DeLeadEarningCalculatorTest.class);
//    @Value("#{applicationPropertiesList['de.lead.ec.url']}")
