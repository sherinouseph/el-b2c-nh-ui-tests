...
public abstract class BaseOTLandingPageToSalesforceTest extends BaseSalesforceTest {
    private static final Logger logger = LoggerFactory.getLogger(BaseOTLandingPageToSalesforceTest.class);
