...
//
//public class FRBankTransferLiveTest extends BaseBankTransferTest {
//    private static final Logger logger = LoggerFactory.getLogger(FRBankTransferLiveTest.class);
//
//
//    @BeforeTest
//    public void setup(){
