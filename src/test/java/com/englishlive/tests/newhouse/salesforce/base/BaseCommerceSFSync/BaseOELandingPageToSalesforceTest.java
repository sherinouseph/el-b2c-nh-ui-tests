...
public abstract class BaseOELandingPageToSalesforceTest extends BaseSalesforceTest {
    private static final Logger logger = LoggerFactory.getLogger(BaseOELandingPageToSalesforceTest.class);
