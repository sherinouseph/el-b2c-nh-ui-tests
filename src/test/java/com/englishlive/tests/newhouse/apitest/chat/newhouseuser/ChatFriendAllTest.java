//package com.englishlive.tests.newhouse.apitest.chat.newhouseuser;
///**
// * Nikol Apr 2018
// * Chat test  New house use new house User
...
//
//// todo: new house users are not visible ... boston and Oliver trying to fix this for months
//
//public class ChatFriendAllTest extends BaseChatSpecSuite {
//    public static final Logger logger = LoggerFactory.getLogger(ChatFriendAllTest.class);
//
//    protected String memberPageUrl = "/tr-tr/buy/default/member/?ctr=tr";
//    private boolean isCreateNewUser = true;
//
//
//    @BeforeClass
//    protected void setupCreateUsersBeforeClass() {
//        memberPageUrl = getBASE_PROFILE_URL() + memberPageUrl;
//        logger.info("@setupCreateUsersBeforeClass ...! memberPageUrl - " + memberPageUrl);
//        setGridEnvironmentFromDargs();
//        isNewHouseLogin     = true;
...
//        studentBean.setOffer_id(BUY_CC_OFFER_ID); //("32282");
...
//
//    /**
//     * need to set user profile to public
//     *
//     */
//    @Test(dependsOnMethods = "createTestUsers")
//    protected void setTestUserProfilesPublic() {
//        logger.info("setTestUserProfilesPublic ...!");
//        for(ChatTestUserBean chatTestUserBean : chatTestUserList) {
//            chatApiPutProfilePrivacyAndStatus("profile_privacy", "Public", chatTestUserBean);
//            chatApiPutProfilePrivacyAndStatus("chat_privacy", "Public", chatTestUserBean);
//            //chatApiPutProfilePrivacyAndStatus("profile_privacy", "Public" , chatTestUserBean1);
//        }
//
//    }
//    /**
//     * Send friend request
//     */
//    @Test(dependsOnMethods = "setTestUserProfilesPublic")
//    protected void user1SendAFriendRequestToUser2() {
//        chatApiPostFriend(FriendAction.ADD, chatTestUserBean1, chatTestUserBean2.getEfId());
//    }
//
//    /**
