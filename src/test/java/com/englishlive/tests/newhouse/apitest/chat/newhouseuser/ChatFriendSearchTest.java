...
public class ChatFriendSearchTest extends BaseChatSpecSuite {
    public static final Logger logger = LoggerFactory.getLogger(ChatFriendSearchTest.class);
    ...
    protected void setupTestUser(){
        ...
        /**
         * (given_name, family_name, identifier,  identifier_type,  Gender gender,  country_code,  email,  profile_privacy,  chat_privacy, english_level,  english_level_code)          */
