...
//public class FiEnWwsCheckPageContainsNglishtownTest extends BaseCheckPageContainsText {
//    private static final Logger logger = LoggerFactory.getLogger(FiEnWwsCheckPageContainsNglishtownTest.class);
