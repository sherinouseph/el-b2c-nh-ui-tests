...
//public class PfFrWwsCheckPageContainsNglishtownTest extends BaseCheckPageContainsText {
//    private static final Logger logger = LoggerFactory.getLogger(PfFrWwsCheckPageContainsNglishtownTest.class);
