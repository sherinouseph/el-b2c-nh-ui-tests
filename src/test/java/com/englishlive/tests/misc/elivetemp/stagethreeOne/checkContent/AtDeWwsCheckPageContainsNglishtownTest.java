...
//public class AtDeWwsCheckPageContainsNglishtownTest extends BaseCheckPageContainsText {
//    private static final Logger logger = LoggerFactory.getLogger(AtDeWwsCheckPageContainsNglishtownTest.class);
