...
//
//
//public class ItOpenHomePageWithPtnCheckPartnerAndCubitTrackin extends BaseCheckPartnerAndCubitTrackin {
//    private static final Logger logger = LoggerFactory.getLogger(ItOpenHomePageWithPtnCheckPartnerAndCubitTrackin.class);
