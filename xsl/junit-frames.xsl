...
<xsl:param name="hostname">base.url</xsl:param>
<xsl:param name="timestamp">now.time</xsl:param>
    ...
    <html>
       ...
       <!--xsl:variable name="successRate" select="($testCount - $failureCount - $errorCount) div $testCount"/-->
        ...
        <tr valign="top">
            ...
            <td><a title="Displays all skipped"><xsl:value-of select="$skippedCount"/></a></td>
            <td>
                ...
                <tr valign="top">
                    ...
                    <xsl:attribute name="class">
                        <xsl:choose>
                            ...
                            <xsl:when test="sum($insamepackage/@skipped) &gt; 0">Skipped</xsl:when>
                            <xsl:otherwise>Pass</xsl:otherwise>
                        </xsl:choose>
                    </xsl:attribute>
...
<xsl:template name="testsuite.test.header">
    <tr valign="top">
        ...
        <th>Failures</th>
        <th>Skipped</th>
        <th nowrap="nowrap">Run Duration (Secs)</th>
...
<xsl:template name="testcase.test.header">
	...
	<xsl:if test="boolean($show.class)">
        ...
        <th>Status</th>
        <!--th width="80%">Type</th-->
        <th width="40%">Status Description</th>
        <th nowrap="nowrap">Duration (Secs)</th>
    </tr>
</xsl:template>
    ...
    <tr valign="top">
        <xsl:attribute name="class">
            <xsl:choose>
                ...
                <xsl:when test="@skipped[.&gt; 0]">Skipped</xsl:when>
                <xsl:otherwise>Pass</xsl:otherwise>
            </xsl:choose>
        </xsl:attribute>
        ...
        <td>
            <xsl:choose>
                <xsl:when test="@skipped != 0">
                    <a title="Display only skipped tests"><xsl:apply-templates select="@skipped"/></a>
                </xsl:when>
                <xsl:otherwise>
